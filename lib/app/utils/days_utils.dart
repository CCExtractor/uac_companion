...
//* to display the repeated days in more_settings_view.dart
...
String flutterDaysListToString(List<int> days) {
  ...
  if (daysChoosen.length == allDays.length) return 'Daily';
  if (daysChoosen.containsAll(weekdays) && daysChoosen.length == weekdays.length) {
    return 'Weekdays';
  }
